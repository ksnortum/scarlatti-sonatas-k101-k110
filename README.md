# scarlatti-sonatas-k101-k110

[LilyPond](https://lilypond.org/) engraving source files used to create Scarlatti's sonatas K101 through K110.
...
PDF and MIDI files can be created by compiling an `ly` file with LilyPond, that is, for instance, issuing the following command (assuming you have `lilypond` in your PATH variable):
        ...
        lilypond sonata-k101.ly

To create a smaller PDF, try:

        lilypond -dno-point-and-click sonata-k101.ly

You can also [download the latest release](https://github.com/ksnortum/scarlatti-sonatas-k101-k110/releases/latest) to get the compiled PDF and MIDI files.
